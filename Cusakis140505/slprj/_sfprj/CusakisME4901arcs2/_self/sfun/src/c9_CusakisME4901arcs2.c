...
static void initialize_c9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static void initialize_params_c9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static void enable_c9_CusakisME4901arcs2(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance);
static void disable_c9_CusakisME4901arcs2(SFc9_CusakisME4901arcs2InstanceStruct *
  chartInstance);
static void c9_update_debugger_state_c9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static void set_sim_state_c9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance, const mxArray *c9_st);
static void finalize_c9_CusakisME4901arcs2(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance);
static void sf_c9_CusakisME4901arcs2(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance);
static void initSimStructsc9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static void registerMessagesc9_CusakisME4901arcs2
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_j, const char_T *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static void c9_c_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_but, const char_T *c9_identifier, real_T
  c9_y[4]);
static void c9_d_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  real_T c9_y[4]);
...
static void c9_e_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const char_T *c9_identifier, real_T c9_y
  [2]);
static void c9_f_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  real_T c9_y[2]);
...
static const mxArray *c9_f_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_g_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_h_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_CusakisME4901arcs2, const
  char_T *c9_identifier);
static uint8_T c9_i_emlrt_marshallIn(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_CusakisME4901arcs2InstanceStruct
  *chartInstance);
  ...
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_CusakisME4901arcs2 = 0U;
}
  ...
  (SFc9_CusakisME4901arcs2InstanceStruct *chartInstance)
{
  ...
  c9_b_hoistedGlobal = chartInstance->c9_is_active_c9_CusakisME4901arcs2;
...
const mxArray *sf_c9_CusakisME4901arcs2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c9_identifier)
{
  ...
  c9_y = c9_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_CusakisME4901arcs2), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_CusakisME4901arcs2);
  return c9_y;
}
...
void sf_c9_CusakisME4901arcs2_get_check_sum(mxArray *plhs[])
{
...
static const mxArray *sf_get_sim_state_info_c9_CusakisME4901arcs2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"but\",},{M[1],M[10],T\"j\",},{M[1],M[4],T\"u\",},{M[8],M[0],T\"is_active_c9_CusakisME4901arcs2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_CusakisME4901arcs2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c9_CusakisME4901arcs2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
  initialize_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_CusakisME4901arcs2(void *chartInstanceVar)
{
  enable_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_CusakisME4901arcs2(void *chartInstanceVar)
{
  disable_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_CusakisME4901arcs2(void *chartInstanceVar)
{
  sf_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_CusakisME4901arcs2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_CusakisME4901arcs2
    ((SFc9_CusakisME4901arcs2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_CusakisME4901arcs2();/* state var info */
...
extern void sf_internal_set_sim_state_c9_CusakisME4901arcs2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_CusakisME4901arcs2(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_CusakisME4901arcs2(S);
}

static void sf_opaque_set_sim_state_c9_CusakisME4901arcs2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_CusakisME4901arcs2(S, st);
}

static void sf_opaque_terminate_c9_CusakisME4901arcs2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_CusakisME4901arcs2InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_CusakisME4901arcs2((SFc9_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_CusakisME4901arcs2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_CusakisME4901arcs2
      ((SFc9_CusakisME4901arcs2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlRTW_c9_CusakisME4901arcs2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_CusakisME4901arcs2(SimStruct *S)
{
  SFc9_CusakisME4901arcs2InstanceStruct *chartInstance;
  chartInstance = (SFc9_CusakisME4901arcs2InstanceStruct *)utMalloc(sizeof
    (SFc9_CusakisME4901arcs2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_CusakisME4901arcs2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_CusakisME4901arcs2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_CusakisME4901arcs2;
...
void c9_CusakisME4901arcs2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_CusakisME4901arcs2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_CusakisME4901arcs2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_CusakisME4901arcs2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_CusakisME4901arcs2_method_dispatcher.\n"
