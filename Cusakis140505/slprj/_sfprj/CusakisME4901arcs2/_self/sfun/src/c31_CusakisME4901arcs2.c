...
static void initialize_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void initialize_params_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void enable_c31_CusakisME4901arcs2(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance);
static void disable_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void c31_update_debugger_state_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void set_sim_state_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance, const mxArray *c31_st);
static void finalize_c31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void sf_c31_CusakisME4901arcs2(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance);
static void initSimStructsc31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
static void registerMessagesc31_CusakisME4901arcs2
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static uint8_T c31_emlrt_marshallIn(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c31_LoO, const char_T *c31_identifier);
static uint8_T c31_b_emlrt_marshallIn(SFc31_CusakisME4901arcs2InstanceStruct
...
static const mxArray *c31_b_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_c_emlrt_marshallIn(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static const mxArray *c31_c_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_d_emlrt_marshallIn(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  uint8_T c31_y[2]);
static void c31_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static void c31_typecast(SFc31_CusakisME4901arcs2InstanceStruct *chartInstance,
  int16_T c31_x, uint8_T c31_y[2]);
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_e_emlrt_marshallIn(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static void init_dsm_address_info(SFc31_CusakisME4901arcs2InstanceStruct
  *chartInstance);
  ...
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_CusakisME4901arcs2 = 0U;
}
  ...
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance)
{
  ...
  c31_m_hoistedGlobal = chartInstance->c31_is_active_c31_CusakisME4901arcs2;
  ...
  (SFc31_CusakisME4901arcs2InstanceStruct *chartInstance, const mxArray *c31_st)
{
  ...
  *c31_LoO = c31_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c31_u,
    11)), "LoO");
  chartInstance->c31_is_active_c31_CusakisME4901arcs2 = c31_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 12)),
     "is_active_c31_CusakisME4901arcs2");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_CusakisME4901arcs2(chartInstance);
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_CusakisME4901arcs2InstanceStruct *chartInstance;
  chartInstance = (SFc31_CusakisME4901arcs2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_CusakisME4901arcs2_get_eml_resolved_functions_info(void)
{
...
void sf_c31_CusakisME4901arcs2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c31_CusakisME4901arcs2_get_autoinheritance_info(void)
{
...
mxArray *sf_c31_CusakisME4901arcs2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c31_CusakisME4901arcs2(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[16],T\"LoM3\",},{M[1],M[21],T\"LoO\",},{M[8],M[0],T\"is_active_c31_CusakisME4901arcs2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 13, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_CusakisME4901arcs2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc31_CusakisME4901arcs2InstanceStruct *chartInstance;
    chartInstance = (SFc31_CusakisME4901arcs2InstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c31_CusakisME4901arcs2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_CusakisME4901arcs2
    ((SFc31_CusakisME4901arcs2InstanceStruct*) chartInstanceVar);
  initialize_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c31_CusakisME4901arcs2(void *chartInstanceVar)
{
  enable_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c31_CusakisME4901arcs2(void *chartInstanceVar)
{
  disable_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c31_CusakisME4901arcs2(void *chartInstanceVar)
{
  sf_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c31_CusakisME4901arcs2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c31_CusakisME4901arcs2
    ((SFc31_CusakisME4901arcs2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c31_CusakisME4901arcs2();/* state var info */
...
extern void sf_internal_set_sim_state_c31_CusakisME4901arcs2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c31_CusakisME4901arcs2(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c31_CusakisME4901arcs2(S);
}

static void sf_opaque_set_sim_state_c31_CusakisME4901arcs2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c31_CusakisME4901arcs2(S, st);
}

static void sf_opaque_terminate_c31_CusakisME4901arcs2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_CusakisME4901arcs2InstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc31_CusakisME4901arcs2((SFc31_CusakisME4901arcs2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_CusakisME4901arcs2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c31_CusakisME4901arcs2
      ((SFc31_CusakisME4901arcs2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c31_CusakisME4901arcs2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c31_CusakisME4901arcs2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_CusakisME4901arcs2(SimStruct *S)
{
  SFc31_CusakisME4901arcs2InstanceStruct *chartInstance;
  chartInstance = (SFc31_CusakisME4901arcs2InstanceStruct *)utMalloc(sizeof
    (SFc31_CusakisME4901arcs2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_CusakisME4901arcs2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_CusakisME4901arcs2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c31_CusakisME4901arcs2;
...
void c31_CusakisME4901arcs2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_CusakisME4901arcs2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_CusakisME4901arcs2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_CusakisME4901arcs2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_CusakisME4901arcs2_method_dispatcher.\n"
