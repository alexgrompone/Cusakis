...
static void initialize_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static void initialize_params_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static void enable_c32_ManipulatorME4901(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance);
static void disable_c32_ManipulatorME4901(SFc32_ManipulatorME4901InstanceStruct *
  chartInstance);
static void c32_update_debugger_state_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static void set_sim_state_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c32_st);
static void finalize_c32_ManipulatorME4901(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance);
static void sf_c32_ManipulatorME4901(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c32_chartstep_c32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static void initSimStructsc32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
static void registerMessagesc32_ManipulatorME4901
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance);
...
static const mxArray *c32_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static uint8_T c32_emlrt_marshallIn(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c32_checksum, const char_T *c32_identifier);
static uint8_T c32_b_emlrt_marshallIn(SFc32_ManipulatorME4901InstanceStruct
...
static const mxArray *c32_c_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static real_T c32_c_emlrt_marshallIn(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
...
static const mxArray *c32_d_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_d_emlrt_marshallIn(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId,
  int16_T c32_y[13]);
...
static void c32_eml_scalar_eg(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance);
static const mxArray *c32_e_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static int32_T c32_e_emlrt_marshallIn(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void c32_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData);
static void init_dsm_address_info(SFc32_ManipulatorME4901InstanceStruct
  *chartInstance);
  ...
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance)
{
  ...
  chartInstance->c32_is_active_c32_ManipulatorME4901 = 0U;
}
  ...
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance)
{
  ...
  c32_b_hoistedGlobal = chartInstance->c32_is_active_c32_ManipulatorME4901;
  ...
  (SFc32_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c32_st)
{
  ...
  *c32_checksum = c32_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c32_u, 0)), "checksum");
  chartInstance->c32_is_active_c32_ManipulatorME4901 = c32_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c32_u, 1)),
     "is_active_c32_ManipulatorME4901");
  sf_mex_destroy(&c32_u);
  c32_update_debugger_state_c32_ManipulatorME4901(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c32_sfEvent = CALL_EVENT;
  c32_chartstep_c32_ManipulatorME4901(chartInstance);
  ...
  *c32_inData)
{
  ...
  const mxArray *c32_y = NULL;
  SFc32_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc32_ManipulatorME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c32_ManipulatorME4901_get_eml_resolved_functions_info(void)
{
...
void sf_c32_ManipulatorME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c32_ManipulatorME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c32_ManipulatorME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c32_ManipulatorME4901(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"checksum\",},{M[8],M[0],T\"is_active_c32_ManipulatorME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c32_ManipulatorME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc32_ManipulatorME4901InstanceStruct *chartInstance;
    chartInstance = (SFc32_ManipulatorME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c32_ManipulatorME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c32_ManipulatorME4901(void *chartInstanceVar)
{
  enable_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c32_ManipulatorME4901(void *chartInstanceVar)
{
  disable_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c32_ManipulatorME4901(void *chartInstanceVar)
{
  sf_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c32_ManipulatorME4901(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c32_ManipulatorME4901
    ((SFc32_ManipulatorME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c32_ManipulatorME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c32_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c32_ManipulatorME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c32_ManipulatorME4901(S);
}

static void sf_opaque_set_sim_state_c32_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c32_ManipulatorME4901(S, st);
}

static void sf_opaque_terminate_c32_ManipulatorME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc32_ManipulatorME4901InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc32_ManipulatorME4901((SFc32_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c32_ManipulatorME4901(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c32_ManipulatorME4901
      ((SFc32_ManipulatorME4901InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c32_ManipulatorME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c32_ManipulatorME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c32_ManipulatorME4901(SimStruct *S)
{
  SFc32_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc32_ManipulatorME4901InstanceStruct *)utMalloc(sizeof
    (SFc32_ManipulatorME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc32_ManipulatorME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c32_ManipulatorME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c32_ManipulatorME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c32_ManipulatorME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c32_ManipulatorME4901;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c32_ManipulatorME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c32_ManipulatorME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c32_ManipulatorME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c32_ManipulatorME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c32_ManipulatorME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c32_ManipulatorME4901;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c32_ManipulatorME4901;
...
void c32_ManipulatorME4901_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c32_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c32_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c32_ManipulatorME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c32_ManipulatorME4901_method_dispatcher.\n"
