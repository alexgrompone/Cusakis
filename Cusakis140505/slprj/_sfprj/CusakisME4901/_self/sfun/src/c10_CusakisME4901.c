...
const mxArray *sf_c10_CusakisME4901_get_eml_resolved_functions_info(void)
{
  ...
  (*c10_b_info)[66].context =
    "[E]C:/Users/Grompone/Desktop/Cusakis140304/collision_function.p";
...
static void mdlSetWorkWidths_c10_CusakisME4901(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1867646997U));
  ssSetChecksum1(S,(4226292649U));
  ssSetChecksum2(S,(593718657U));
  ssSetChecksum3(S,(1234157818U));
