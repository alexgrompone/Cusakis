...
static void initialize_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void initialize_params_c22_CusakisME4901
  (SFc22_CusakisME4901InstanceStruct *chartInstance);
static void enable_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void disable_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void c22_update_debugger_state_c22_CusakisME4901
  (SFc22_CusakisME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c22_CusakisME4901
  (SFc22_CusakisME4901InstanceStruct *chartInstance);
static void set_sim_state_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_st);
static void finalize_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void sf_c22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void initSimStructsc22_CusakisME4901(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
static void registerMessagesc22_CusakisME4901(SFc22_CusakisME4901InstanceStruct *
  chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_orbit, const char_T *c22_identifier, real_T
  c22_y[3]);
static void c22_b_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real_T c22_c_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
...
static const mxArray *c22_c_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_d_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint8_T c22_e_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_b_is_active_c22_CusakisME4901, const char_T
  *c22_identifier);
static uint8_T c22_f_emlrt_marshallIn(SFc22_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void init_dsm_address_info(SFc22_CusakisME4901InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_CusakisME4901 = 0U;
}
  ...
  (SFc22_CusakisME4901InstanceStruct *chartInstance)
{
  ...
  c22_hoistedGlobal = chartInstance->c22_is_active_c22_CusakisME4901;
  ...
  *chartInstance, const mxArray *c22_st)
{
  ...
  chartInstance->c22_is_active_c22_CusakisME4901 = c22_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 1)),
     "is_active_c22_CusakisME4901");
  sf_mex_destroy(&c22_u);
  c22_update_debugger_state_c22_CusakisME4901(chartInstance);
  ...
  *c22_inData)
{
  ...
  const mxArray *c22_y = NULL;
  SFc22_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc22_CusakisME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c22_CusakisME4901_get_eml_resolved_functions_info(void)
{
  ...
  *c22_identifier)
{
  ...
  c22_y = c22_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c22_b_is_active_c22_CusakisME4901), &c22_thisId);
  sf_mex_destroy(&c22_b_is_active_c22_CusakisME4901);
  return c22_y;
}
...
void sf_c22_CusakisME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c22_CusakisME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c22_CusakisME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c22_CusakisME4901(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"orbit\",},{M[8],M[0],T\"is_active_c22_CusakisME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_CusakisME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc22_CusakisME4901InstanceStruct *chartInstance;
    chartInstance = (SFc22_CusakisME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c22_CusakisME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_CusakisME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c22_CusakisME4901(void *chartInstanceVar)
{
  enable_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_CusakisME4901(void *chartInstanceVar)
{
  disable_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c22_CusakisME4901(void *chartInstanceVar)
{
  sf_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c22_CusakisME4901(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_CusakisME4901
    ((SFc22_CusakisME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_CusakisME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c22_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c22_CusakisME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c22_CusakisME4901(S);
}

static void sf_opaque_set_sim_state_c22_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c22_CusakisME4901(S, st);
}

static void sf_opaque_terminate_c22_CusakisME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_CusakisME4901InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_CusakisME4901_optimization_info();
    }

    finalize_c22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc22_CusakisME4901((SFc22_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_CusakisME4901(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c22_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c22_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_CusakisME4901(SimStruct *S)
{
  SFc22_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc22_CusakisME4901InstanceStruct *)utMalloc(sizeof
    (SFc22_CusakisME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_CusakisME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c22_CusakisME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c22_CusakisME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c22_CusakisME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_CusakisME4901;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_CusakisME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c22_CusakisME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c22_CusakisME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c22_CusakisME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_CusakisME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_CusakisME4901;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_CusakisME4901;
...
void c22_CusakisME4901_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_CusakisME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_CusakisME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_CusakisME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_CusakisME4901_method_dispatcher.\n"
