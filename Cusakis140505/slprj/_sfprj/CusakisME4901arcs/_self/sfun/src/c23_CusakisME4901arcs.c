...
static const char * c23_debug_family_names[5] = { "udeg", "nargin", "nargout",
  "u", "y" };

/* Function Declarations */
static void initialize_c23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
static void initialize_params_c23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
static void enable_c23_CusakisME4901arcs(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void disable_c23_CusakisME4901arcs(SFc23_CusakisME4901arcsInstanceStruct *
  chartInstance);
static void c23_update_debugger_state_c23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
static void set_sim_state_c23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance, const mxArray *c23_st);
static void finalize_c23_CusakisME4901arcs(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void sf_c23_CusakisME4901arcs(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void initSimStructsc23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
static void registerMessagesc23_CusakisME4901arcs
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance);
...
static const mxArray *c23_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_emlrt_marshallIn(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c23_y, const char_T *c23_identifier);
static real_T c23_b_emlrt_marshallIn(SFc23_CusakisME4901arcsInstanceStruct
...
static const mxArray *c23_b_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_c_emlrt_marshallIn(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_d_emlrt_marshallIn(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c23_b_is_active_c23_CusakisME4901arcs, const
  char_T *c23_identifier);
static uint8_T c23_e_emlrt_marshallIn(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_CusakisME4901arcsInstanceStruct
  *chartInstance);
  ...
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_CusakisME4901arcs = 0U;
}
  ...
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance)
{
  ...
  c23_b_hoistedGlobal = chartInstance->c23_is_active_c23_CusakisME4901arcs;
  ...
  (SFc23_CusakisME4901arcsInstanceStruct *chartInstance, const mxArray *c23_st)
{
  ...
  *c23_y = c23_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c23_u,
    0)), "y");
  chartInstance->c23_is_active_c23_CusakisME4901arcs = c23_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c23_u, 1)),
     "is_active_c23_CusakisME4901arcs");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_CusakisME4901arcs(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c23_b_u;
  real_T *c23_c_y;
  c23_c_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c23_c_y, 1U);
  chartInstance->c23_sfEvent = CALL_EVENT;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c23_udeg, 0U, c23_sf_marshallOut,
    c23_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c23_nargin, 1U, c23_sf_marshallOut,
    c23_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c23_nargout, 2U, c23_sf_marshallOut,
    c23_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c23_u, 3U, c23_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c23_y, 4U, c23_sf_marshallOut,
    c23_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c23_x = c23_A;
  c23_b_x = c23_x;
  c23_udeg = c23_b_x / 3.1415926535897931;
  _SFD_EML_CALL(0U, chartInstance->c23_sfEvent, 6);
  c23_b_a = c23_udeg + 180.0;
  c23_y = c23_b_a * 10.0;
  _SFD_EML_CALL(0U, chartInstance->c23_sfEvent, -6);
  ...
  *c23_inData)
{
  ...
  const mxArray *c23_y = NULL;
  SFc23_CusakisME4901arcsInstanceStruct *chartInstance;
  chartInstance = (SFc23_CusakisME4901arcsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_CusakisME4901arcs_get_eml_resolved_functions_info(void)
{
  const mxArray *c23_nameCaptureInfo;
  c23_ResolvedFunctionInfo c23_info[5];
  c23_ResolvedFunctionInfo (*c23_b_info)[5];
  const mxArray *c23_m0 = NULL;
  int32_T c23_i0;
  c23_ResolvedFunctionInfo *c23_r0;
  c23_nameCaptureInfo = NULL;
  c23_nameCaptureInfo = NULL;
  c23_b_info = (c23_ResolvedFunctionInfo (*)[5])c23_info;
  (*c23_b_info)[0].context = "";
  (*c23_b_info)[0].name = "mtimes";
  (*c23_b_info)[0].dominantType = "double";
  (*c23_b_info)[0].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  (*c23_b_info)[0].fileTimeLo = 1289552092U;
  ...
  (*c23_b_info)[1].fileTimeLo = 1357983948U;
  (*c23_b_info)[1].fileTimeHi = 0U;
  (*c23_b_info)[1].mFileTimeLo = 1319762366U;
  ...
  (*c23_b_info)[2].fileTimeLo = 1346542788U;
  ...
  (*c23_b_info)[3].fileTimeLo = 1286851196U;
  ...
  (*c23_b_info)[4].fileTimeLo = 1313380210U;
  (*c23_b_info)[4].fileTimeHi = 0U;
  (*c23_b_info)[4].mFileTimeLo = 0U;
  (*c23_b_info)[4].mFileTimeHi = 0U;
  sf_mex_assign(&c23_m0, sf_mex_createstruct("nameCaptureInfo", 1, 5), FALSE);
  for (c23_i0 = 0; c23_i0 < 5; c23_i0++) {
  ...
  char_T *c23_identifier)
{
  ...
  c23_y = c23_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_CusakisME4901arcs), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_CusakisME4901arcs);
  return c23_y;
}
...
void sf_c23_CusakisME4901arcs_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c23_CusakisME4901arcs_get_autoinheritance_info(void)
{
...
mxArray *sf_c23_CusakisME4901arcs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c23_CusakisME4901arcs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c23_CusakisME4901arcs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_CusakisME4901arcs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc23_CusakisME4901arcsInstanceStruct *chartInstance;
    chartInstance = (SFc23_CusakisME4901arcsInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c23_CusakisME4901arcs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
  initialize_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_CusakisME4901arcs(void *chartInstanceVar)
{
  enable_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c23_CusakisME4901arcs(void *chartInstanceVar)
{
  disable_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_CusakisME4901arcs(void *chartInstanceVar)
{
  sf_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c23_CusakisME4901arcs(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c23_CusakisME4901arcs
    ((SFc23_CusakisME4901arcsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c23_CusakisME4901arcs();/* state var info */
...
extern void sf_internal_set_sim_state_c23_CusakisME4901arcs(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c23_CusakisME4901arcs(SimStruct* S)
{
  return sf_internal_get_sim_state_c23_CusakisME4901arcs(S);
}

static void sf_opaque_set_sim_state_c23_CusakisME4901arcs(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c23_CusakisME4901arcs(S, st);
}

static void sf_opaque_terminate_c23_CusakisME4901arcs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_CusakisME4901arcsInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_CusakisME4901arcs((SFc23_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_CusakisME4901arcs(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c23_CusakisME4901arcs
      ((SFc23_CusakisME4901arcsInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c23_CusakisME4901arcs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c23_CusakisME4901arcs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_CusakisME4901arcs(SimStruct *S)
{
  SFc23_CusakisME4901arcsInstanceStruct *chartInstance;
  chartInstance = (SFc23_CusakisME4901arcsInstanceStruct *)utMalloc(sizeof
    (SFc23_CusakisME4901arcsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_CusakisME4901arcsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_CusakisME4901arcs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_CusakisME4901arcs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_CusakisME4901arcs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c23_CusakisME4901arcs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c23_CusakisME4901arcs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_CusakisME4901arcs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_CusakisME4901arcs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_CusakisME4901arcs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_CusakisME4901arcs;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_CusakisME4901arcs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c23_CusakisME4901arcs;
...
void c23_CusakisME4901arcs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_CusakisME4901arcs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_CusakisME4901arcs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_CusakisME4901arcs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_CusakisME4901arcs_method_dispatcher.\n"
