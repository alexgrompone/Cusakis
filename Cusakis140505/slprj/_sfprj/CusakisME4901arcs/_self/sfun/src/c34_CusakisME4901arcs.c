...
static void initialize_c34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
static void initialize_params_c34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
static void enable_c34_CusakisME4901arcs(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void disable_c34_CusakisME4901arcs(SFc34_CusakisME4901arcsInstanceStruct *
  chartInstance);
static void c34_update_debugger_state_c34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
static void set_sim_state_c34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance, const mxArray *c34_st);
static void finalize_c34_CusakisME4901arcs(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void sf_c34_CusakisME4901arcs(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance);
static void initSimStructsc34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
static void registerMessagesc34_CusakisME4901arcs
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance);
...
static const mxArray *c34_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static uint8_T c34_emlrt_marshallIn(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c34_LoL, const char_T *c34_identifier);
static uint8_T c34_b_emlrt_marshallIn(SFc34_CusakisME4901arcsInstanceStruct
...
static const mxArray *c34_b_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static real_T c34_c_emlrt_marshallIn(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
...
static const mxArray *c34_c_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static void c34_d_emlrt_marshallIn(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId,
  uint8_T c34_y[2]);
static void c34_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c34_mxArrayInData, const char_T *c34_varName, void *c34_outData);
static void c34_typecast(SFc34_CusakisME4901arcsInstanceStruct *chartInstance,
  int16_T c34_x, uint8_T c34_y[2]);
static const mxArray *c34_d_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static int32_T c34_e_emlrt_marshallIn(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
static void c34_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c34_mxArrayInData, const char_T *c34_varName, void *c34_outData);
static void init_dsm_address_info(SFc34_CusakisME4901arcsInstanceStruct
  *chartInstance);
  ...
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c34_is_active_c34_CusakisME4901arcs = 0U;
}
  ...
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance)
{
  ...
  c34_e_hoistedGlobal = chartInstance->c34_is_active_c34_CusakisME4901arcs;
  ...
  (SFc34_CusakisME4901arcsInstanceStruct *chartInstance, const mxArray *c34_st)
{
  ...
  *c34_LoR = c34_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c34_u,
    3)), "LoR");
  chartInstance->c34_is_active_c34_CusakisME4901arcs = c34_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c34_u, 4)),
     "is_active_c34_CusakisME4901arcs");
  sf_mex_destroy(&c34_u);
  c34_update_debugger_state_c34_CusakisME4901arcs(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (c34_d0 < 32768.0) {
    if (CV_SATURATION_EVAL(4, 0, 0, 1, c34_d0 >= -32768.0)) {
      c34_i0 = (int16_T)c34_d0;
    } else {
      c34_i0 = MIN_int16_T;
    }
  } else if (CV_SATURATION_EVAL(4, 0, 0, 0, c34_d0 >= 32768.0)) {
    c34_i0 = MAX_int16_T;
  } else {
    c34_i0 = 0;
  }
  ...
  if (c34_d1 < 32768.0) {
    if (CV_SATURATION_EVAL(4, 0, 1, 1, c34_d1 >= -32768.0)) {
      c34_i2 = (int16_T)c34_d1;
    } else {
      c34_i2 = MIN_int16_T;
    }
  } else if (CV_SATURATION_EVAL(4, 0, 1, 0, c34_d1 >= 32768.0)) {
    c34_i2 = MAX_int16_T;
  } else {
    c34_i2 = 0;
  }
  ...
  _SFD_EML_CALL(0U, chartInstance->c34_sfEvent, 17);
  c34_HiL = c34_L[1];
  ...
  *c34_inData)
{
  ...
  const mxArray *c34_y = NULL;
  SFc34_CusakisME4901arcsInstanceStruct *chartInstance;
  chartInstance = (SFc34_CusakisME4901arcsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c34_CusakisME4901arcs_get_eml_resolved_functions_info(void)
{
...
void sf_c34_CusakisME4901arcs_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1375883086U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(791892935U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2909928870U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2481154251U);
}

mxArray *sf_c34_CusakisME4901arcs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iAm7si9I1ihIh0roIWVQVB");
...
mxArray *sf_c34_CusakisME4901arcs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c34_CusakisME4901arcs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"HiL\",},{M[1],M[5],T\"HiR\",},{M[1],M[9],T\"LoL\",},{M[1],M[7],T\"LoR\",},{M[8],M[0],T\"is_active_c34_CusakisME4901arcs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c34_CusakisME4901arcs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc34_CusakisME4901arcsInstanceStruct *chartInstance;
    chartInstance = (SFc34_CusakisME4901arcsInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_SATURATION(0,1,0,100,-1,111);
        _SFD_CV_INIT_EML_SATURATION(0,1,1,188,-1,199);
...
{
  return "j1H6N2KNcRpvTMiiKgiDsG";
}

static void sf_opaque_initialize_c34_CusakisME4901arcs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
  initialize_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c34_CusakisME4901arcs(void *chartInstanceVar)
{
  enable_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c34_CusakisME4901arcs(void *chartInstanceVar)
{
  disable_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c34_CusakisME4901arcs(void *chartInstanceVar)
{
  sf_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c34_CusakisME4901arcs(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c34_CusakisME4901arcs
    ((SFc34_CusakisME4901arcsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c34_CusakisME4901arcs();/* state var info */
...
extern void sf_internal_set_sim_state_c34_CusakisME4901arcs(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c34_CusakisME4901arcs(SimStruct* S)
{
  return sf_internal_get_sim_state_c34_CusakisME4901arcs(S);
}

static void sf_opaque_set_sim_state_c34_CusakisME4901arcs(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c34_CusakisME4901arcs(S, st);
}

static void sf_opaque_terminate_c34_CusakisME4901arcs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc34_CusakisME4901arcsInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc34_CusakisME4901arcs((SFc34_CusakisME4901arcsInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c34_CusakisME4901arcs(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c34_CusakisME4901arcs
      ((SFc34_CusakisME4901arcsInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c34_CusakisME4901arcs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1333124681U));
  ssSetChecksum1(S,(951655251U));
  ssSetChecksum2(S,(3705380304U));
  ssSetChecksum3(S,(3285952290U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c34_CusakisME4901arcs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c34_CusakisME4901arcs(SimStruct *S)
{
  SFc34_CusakisME4901arcsInstanceStruct *chartInstance;
  chartInstance = (SFc34_CusakisME4901arcsInstanceStruct *)utMalloc(sizeof
    (SFc34_CusakisME4901arcsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc34_CusakisME4901arcsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c34_CusakisME4901arcs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c34_CusakisME4901arcs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c34_CusakisME4901arcs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c34_CusakisME4901arcs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c34_CusakisME4901arcs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c34_CusakisME4901arcs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c34_CusakisME4901arcs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c34_CusakisME4901arcs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c34_CusakisME4901arcs;
  chartInstance->chartInfo.mdlStart = mdlStart_c34_CusakisME4901arcs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c34_CusakisME4901arcs;
...
void c34_CusakisME4901arcs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c34_CusakisME4901arcs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c34_CusakisME4901arcs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c34_CusakisME4901arcs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c34_CusakisME4901arcs_method_dispatcher.\n"
