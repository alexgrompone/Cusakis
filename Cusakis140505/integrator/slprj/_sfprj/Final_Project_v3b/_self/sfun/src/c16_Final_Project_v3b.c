...
static void initialize_c16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
static void initialize_params_c16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
static void enable_c16_Final_Project_v3b(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance);
static void disable_c16_Final_Project_v3b(SFc16_Final_Project_v3bInstanceStruct *
  chartInstance);
static void c16_update_debugger_state_c16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
static void set_sim_state_c16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_Final_Project_v3b(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance);
static void sf_c16_Final_Project_v3b(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance);
static void initSimStructsc16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
static void registerMessagesc16_Final_Project_v3b
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance);
...
static void c16_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_R, const char_T *c16_identifier, real_T
  c16_y[4]);
static void c16_b_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
...
static void c16_c_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_y, const char_T *c16_identifier, real_T
  c16_b_y[9]);
static void c16_d_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[9]);
...
static const mxArray *c16_c_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static const mxArray *c16_d_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_f_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_g_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_Final_Project_v3b, const
  char_T *c16_identifier);
static uint8_T c16_h_emlrt_marshallIn(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_Final_Project_v3bInstanceStruct
  *chartInstance);
  ...
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Final_Project_v3b = 0U;
}
  ...
  (SFc16_Final_Project_v3bInstanceStruct *chartInstance)
{
  ...
  c16_c_y = NULL;
  sf_mex_assign(&c16_c_y, sf_mex_create("y", c16_b_u, 0, 0U, 1U, 0U, 2, 9, 1),
                FALSE);
  sf_mex_setcell(c16_y, 1, c16_c_y);
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_Final_Project_v3b;
  ...
  *c16_inData)
{
  ...
  c16_y = NULL;
  sf_mex_assign(&c16_y, sf_mex_create("y", c16_u, 0, 0U, 1U, 0U, 2, 9, 1), FALSE);
  sf_mex_assign(&c16_mxArrayOutData, c16_y, FALSE);
  return c16_mxArrayOutData;
}
  ...
  real_T c16_y[9])
{
  real_T c16_dv3[9];
  int32_T c16_i20;
  sf_mex_import(c16_parentId, sf_mex_dup(c16_u), c16_dv3, 1, 0, 0U, 1, 0U, 2, 9,
                1);
...
const mxArray *sf_c16_Final_Project_v3b_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Final_Project_v3b), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Final_Project_v3b);
  return c16_y;
}
...
void sf_c16_Final_Project_v3b_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3840143047U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(288087297U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2418527574U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3167527123U);
}
...
mxArray *sf_c16_Final_Project_v3b_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c16_Final_Project_v3b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[6],T\"R\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c16_Final_Project_v3b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Final_Project_v3b_get_check_sum(&mxChecksum);
...
{
  return "JRm43adZvAGYnNLtMsppvG";
}

static void sf_opaque_initialize_c16_Final_Project_v3b(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
  initialize_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_Final_Project_v3b(void *chartInstanceVar)
{
  enable_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_Final_Project_v3b(void *chartInstanceVar)
{
  disable_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_Final_Project_v3b(void *chartInstanceVar)
{
  sf_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_Final_Project_v3b(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Final_Project_v3b
    ((SFc16_Final_Project_v3bInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_Final_Project_v3b();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Final_Project_v3b(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_Final_Project_v3b(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_Final_Project_v3b(S);
}

static void sf_opaque_set_sim_state_c16_Final_Project_v3b(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_Final_Project_v3b(S, st);
}

static void sf_opaque_terminate_c16_Final_Project_v3b(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Final_Project_v3bInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_Final_Project_v3b((SFc16_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Final_Project_v3b(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c16_Final_Project_v3b
      ((SFc16_Final_Project_v3bInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlStart_c16_Final_Project_v3b(SimStruct *S)
{
  SFc16_Final_Project_v3bInstanceStruct *chartInstance;
  chartInstance = (SFc16_Final_Project_v3bInstanceStruct *)utMalloc(sizeof
    (SFc16_Final_Project_v3bInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_Final_Project_v3bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Final_Project_v3b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Final_Project_v3b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Final_Project_v3b;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_Final_Project_v3b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_Final_Project_v3b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Final_Project_v3b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Final_Project_v3b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Final_Project_v3b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_Final_Project_v3b;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_Final_Project_v3b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_Final_Project_v3b;
...
void c16_Final_Project_v3b_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Final_Project_v3b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Final_Project_v3b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Final_Project_v3b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Final_Project_v3b_method_dispatcher.\n"
