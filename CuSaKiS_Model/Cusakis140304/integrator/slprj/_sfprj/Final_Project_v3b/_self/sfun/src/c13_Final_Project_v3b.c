...
static const char * c13_debug_family_names[11] = { "nargin", "nargout", "u1",
  "u2", "u3", "u4", "u5", "u6", "collision", "memory", "y" };

/* Function Declarations */
static void initialize_c13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static void initialize_params_c13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static void enable_c13_Final_Project_v3b(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance);
static void disable_c13_Final_Project_v3b(SFc13_Final_Project_v3bInstanceStruct *
  chartInstance);
static void c13_update_debugger_state_c13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static void set_sim_state_c13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance, const mxArray *c13_st);
static void finalize_c13_Final_Project_v3b(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance);
static void sf_c13_Final_Project_v3b(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance);
static void initSimStructsc13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static void registerMessagesc13_Final_Project_v3b
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c13_y, const char_T *c13_identifier, real_T
  c13_b_y[6]);
static void c13_b_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_c_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_d_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_e_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_Final_Project_v3b, const
  char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_Final_Project_v3bInstanceStruct
  *chartInstance);
  ...
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Final_Project_v3b = 0U;
}
  ...
  (SFc13_Final_Project_v3bInstanceStruct *chartInstance)
{
  ...
  real_T (*c13_d_y)[6];
  c13_d_y = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 1);
  c13_st = NULL;
  c13_st = NULL;
  c13_y = NULL;
  ...
  c13_hoistedGlobal = chartInstance->c13_is_active_c13_Final_Project_v3b;
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_Final_Project_v3bInstanceStruct *chartInstance;
  chartInstance = (SFc13_Final_Project_v3bInstanceStruct *)chartInstanceVoid;
  c13_mxArrayOutData = NULL;
  for (c13_i6 = 0; c13_i6 < 6; c13_i6++) {
    c13_b_inData[c13_i6] = (*(real_T (*)[6])c13_inData)[c13_i6];
  }
  ...
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  ...
  c13_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_y), &c13_thisId, c13_b_y);
  sf_mex_destroy(&c13_y);
  for (c13_i9 = 0; c13_i9 < 6; c13_i9++) {
    (*(real_T (*)[6])c13_outData)[c13_i9] = c13_b_y[c13_i9];
  }
...
const mxArray *sf_c13_Final_Project_v3b_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId)
{
  int32_T c13_y;
  int32_T c13_i10;
  sf_mex_import(c13_parentId, sf_mex_dup(c13_u), &c13_i10, 1, 6, 0U, 0, 0U, 0);
  c13_y = c13_i10;
  sf_mex_destroy(&c13_u);
  return c13_y;
}
  ...
  char_T *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Final_Project_v3b), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Final_Project_v3b);
  return c13_y;
}
...
void sf_c13_Final_Project_v3b_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2042305810U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1566793481U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(699529041U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1188697906U);
}

mxArray *sf_c13_Final_Project_v3b_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zx2Xk0I8YgbhzU659qzuFF");
...
mxArray *sf_c13_Final_Project_v3b_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c13_Final_Project_v3b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c13_Final_Project_v3b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Final_Project_v3b_get_check_sum(&mxChecksum);
...
{
  return "2jegXnJ400ATXb0v1D8u5B";
}

static void sf_opaque_initialize_c13_Final_Project_v3b(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
  initialize_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_Final_Project_v3b(void *chartInstanceVar)
{
  enable_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c13_Final_Project_v3b(void *chartInstanceVar)
{
  disable_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_Final_Project_v3b(void *chartInstanceVar)
{
  sf_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_Final_Project_v3b(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_Final_Project_v3b
    ((SFc13_Final_Project_v3bInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_Final_Project_v3b();/* state var info */
...
extern void sf_internal_set_sim_state_c13_Final_Project_v3b(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_Final_Project_v3b(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_Final_Project_v3b(S);
}

static void sf_opaque_set_sim_state_c13_Final_Project_v3b(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_Final_Project_v3b(S, st);
}

static void sf_opaque_terminate_c13_Final_Project_v3b(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_Final_Project_v3bInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_Final_Project_v3b((SFc13_Final_Project_v3bInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Final_Project_v3b(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_Final_Project_v3b
      ((SFc13_Final_Project_v3bInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlRTW_c13_Final_Project_v3b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_Final_Project_v3b(SimStruct *S)
{
  SFc13_Final_Project_v3bInstanceStruct *chartInstance;
  chartInstance = (SFc13_Final_Project_v3bInstanceStruct *)utMalloc(sizeof
    (SFc13_Final_Project_v3bInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_Final_Project_v3bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_Final_Project_v3b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_Final_Project_v3b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_Final_Project_v3b;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Final_Project_v3b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_Final_Project_v3b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_Final_Project_v3b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_Final_Project_v3b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_Final_Project_v3b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Final_Project_v3b;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Final_Project_v3b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_Final_Project_v3b;
...
void c13_Final_Project_v3b_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Final_Project_v3b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Final_Project_v3b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Final_Project_v3b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Final_Project_v3b_method_dispatcher.\n"
