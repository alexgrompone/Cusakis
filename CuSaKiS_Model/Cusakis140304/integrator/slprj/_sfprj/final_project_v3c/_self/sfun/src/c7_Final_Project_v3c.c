...
static void initialize_c7_Final_Project_v3c(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void initialize_params_c7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void enable_c7_Final_Project_v3c(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void disable_c7_Final_Project_v3c(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void set_sim_state_c7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_Final_Project_v3c(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void sf_c7_Final_Project_v3c(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void initSimStructsc7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void registerMessagesc7_Final_Project_v3c
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_Ya, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
...
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[2]);
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[6]);
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[3]);
...
static real_T c7_rank(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
                      real_T c7_A[6]);
static void c7_eml_error(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void c7_eml_matlab_zsvdc(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, real_T c7_A[6], real_T c7_S[2]);
static void c7_eml_scalar_eg(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static real_T c7_eml_xnrm2(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_x[6]);
static void c7_realmin(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void c7_eml_realmin(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static real_T c7_abs(SFc7_Final_Project_v3cInstanceStruct *chartInstance, real_T
                     c7_x);
static real_T c7_eml_div(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_x, real_T c7_y);
static void c7_eml_xscal(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[6], real_T c7_b_x[6]);
static real_T c7_eml_xdotc(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_x[6], real_T c7_y[6], int32_T c7_iy0);
static void c7_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_y[6], int32_T c7_iy0, real_T c7_b_y[6]);
static real_T c7_b_eml_xnrm2(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_x[3]);
static void c7_b_eml_xscal(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[3], real_T c7_b_x[3]);
static void c7_b_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[6], int32_T c7_ix0, real_T c7_y[2], real_T c7_b_y[2]);
static void c7_c_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[2], real_T c7_y[6], int32_T c7_iy0, real_T c7_b_y[6]);
static void c7_eps(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
static void c7_b_eml_error(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void c7_check_forloop_overflow_error(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, boolean_T c7_overflow);
static void c7_b_check_forloop_overflow_error
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance, boolean_T c7_overflow);
static real_T c7_sqrt(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
                      real_T c7_x);
static void c7_c_eml_error(SFc7_Final_Project_v3cInstanceStruct *chartInstance);
static void c7_eml_xrotg(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
...
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_Final_Project_v3c, const
  char_T *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_c_eml_xscal(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[6]);
static void c7_d_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_y[6], int32_T c7_iy0);
static void c7_d_eml_xscal(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[3]);
static void c7_e_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[6], int32_T c7_ix0, real_T c7_y[2]);
static void c7_f_eml_xaxpy(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T c7_a, real_T c7_x[2], real_T c7_y[6], int32_T c7_iy0);
static void c7_b_sqrt(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
                      real_T *c7_x);
static void c7_b_eml_xrotg(SFc7_Final_Project_v3cInstanceStruct *chartInstance,
  real_T *c7_a, real_T *c7_b, real_T *c7_c, real_T *c7_s);
static void init_dsm_address_info(SFc7_Final_Project_v3cInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_Final_Project_v3c = 0U;
}
  ...
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_Final_Project_v3c;
  ...
  (SFc7_Final_Project_v3cInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *c7_Ya = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
    "Ya");
  chartInstance->c7_is_active_c7_Final_Project_v3c = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_Final_Project_v3c");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_Final_Project_v3c(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_Final_Project_v3cInstanceStruct *chartInstance;
  chartInstance = (SFc7_Final_Project_v3cInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_Final_Project_v3c_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_Final_Project_v3c), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_Final_Project_v3c);
  return c7_y;
}
...
void sf_c7_Final_Project_v3c_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_Final_Project_v3c_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_Final_Project_v3c_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c7_Final_Project_v3c(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Ya\",},{M[8],M[0],T\"is_active_c7_Final_Project_v3c\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_Final_Project_v3c_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_Final_Project_v3cInstanceStruct *chartInstance;
    chartInstance = (SFc7_Final_Project_v3cInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c7_Final_Project_v3c(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
  initialize_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_Final_Project_v3c(void *chartInstanceVar)
{
  enable_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_Final_Project_v3c(void *chartInstanceVar)
{
  disable_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_Final_Project_v3c(void *chartInstanceVar)
{
  sf_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_Final_Project_v3c(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_Final_Project_v3c
    ((SFc7_Final_Project_v3cInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_Final_Project_v3c();/* state var info */
...
extern void sf_internal_set_sim_state_c7_Final_Project_v3c(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_Final_Project_v3c(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_Final_Project_v3c(S);
}

static void sf_opaque_set_sim_state_c7_Final_Project_v3c(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_Final_Project_v3c(S, st);
}

static void sf_opaque_terminate_c7_Final_Project_v3c(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_Final_Project_v3cInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Final_Project_v3c_optimization_info();
    }

    finalize_c7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_Final_Project_v3c((SFc7_Final_Project_v3cInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_Final_Project_v3c(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_Final_Project_v3c(SimStruct *S)
{
...
static void mdlRTW_c7_Final_Project_v3c(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_Final_Project_v3c(SimStruct *S)
{
  SFc7_Final_Project_v3cInstanceStruct *chartInstance;
  chartInstance = (SFc7_Final_Project_v3cInstanceStruct *)utMalloc(sizeof
    (SFc7_Final_Project_v3cInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_Final_Project_v3cInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_Final_Project_v3c;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_Final_Project_v3c;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_Final_Project_v3c;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_Final_Project_v3c;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_Final_Project_v3c;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_Final_Project_v3c;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_Final_Project_v3c;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_Final_Project_v3c;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_Final_Project_v3c;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_Final_Project_v3c;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_Final_Project_v3c;
...
void c7_Final_Project_v3c_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_Final_Project_v3c(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_Final_Project_v3c(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_Final_Project_v3c(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_Final_Project_v3c_method_dispatcher.\n"
