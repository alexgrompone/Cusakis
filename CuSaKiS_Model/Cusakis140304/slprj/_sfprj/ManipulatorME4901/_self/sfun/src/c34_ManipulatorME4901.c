...
static void initialize_c34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
static void initialize_params_c34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
static void enable_c34_ManipulatorME4901(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance);
static void disable_c34_ManipulatorME4901(SFc34_ManipulatorME4901InstanceStruct *
  chartInstance);
static void c34_update_debugger_state_c34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
static void set_sim_state_c34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c34_st);
static void finalize_c34_ManipulatorME4901(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance);
static void sf_c34_ManipulatorME4901(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance);
static void initSimStructsc34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
static void registerMessagesc34_ManipulatorME4901
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance);
...
static const mxArray *c34_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static uint8_T c34_emlrt_marshallIn(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c34_LoL, const char_T *c34_identifier);
static uint8_T c34_b_emlrt_marshallIn(SFc34_ManipulatorME4901InstanceStruct
...
static const mxArray *c34_b_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static real_T c34_c_emlrt_marshallIn(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
...
static const mxArray *c34_c_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static void c34_d_emlrt_marshallIn(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId,
  uint8_T c34_y[2]);
static void c34_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c34_mxArrayInData, const char_T *c34_varName, void *c34_outData);
static void c34_typecast(SFc34_ManipulatorME4901InstanceStruct *chartInstance,
  int16_T c34_x, uint8_T c34_y[2]);
static const mxArray *c34_d_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static int32_T c34_e_emlrt_marshallIn(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
static void c34_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c34_mxArrayInData, const char_T *c34_varName, void *c34_outData);
static void init_dsm_address_info(SFc34_ManipulatorME4901InstanceStruct
  *chartInstance);
  ...
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance)
{
  ...
  chartInstance->c34_is_active_c34_ManipulatorME4901 = 0U;
}
  ...
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance)
{
  ...
  c34_e_hoistedGlobal = chartInstance->c34_is_active_c34_ManipulatorME4901;
  ...
  (SFc34_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c34_st)
{
  ...
  *c34_LoR = c34_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c34_u,
    3)), "LoR");
  chartInstance->c34_is_active_c34_ManipulatorME4901 = c34_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c34_u, 4)),
     "is_active_c34_ManipulatorME4901");
  sf_mex_destroy(&c34_u);
  c34_update_debugger_state_c34_ManipulatorME4901(chartInstance);
  ...
  *c34_inData)
{
  ...
  const mxArray *c34_y = NULL;
  SFc34_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc34_ManipulatorME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c34_ManipulatorME4901_get_eml_resolved_functions_info(void)
{
...
void sf_c34_ManipulatorME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c34_ManipulatorME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c34_ManipulatorME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c34_ManipulatorME4901(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"HiL\",},{M[1],M[5],T\"HiR\",},{M[1],M[9],T\"LoL\",},{M[1],M[7],T\"LoR\",},{M[8],M[0],T\"is_active_c34_ManipulatorME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c34_ManipulatorME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc34_ManipulatorME4901InstanceStruct *chartInstance;
    chartInstance = (SFc34_ManipulatorME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c34_ManipulatorME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c34_ManipulatorME4901(void *chartInstanceVar)
{
  enable_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c34_ManipulatorME4901(void *chartInstanceVar)
{
  disable_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c34_ManipulatorME4901(void *chartInstanceVar)
{
  sf_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c34_ManipulatorME4901(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c34_ManipulatorME4901
    ((SFc34_ManipulatorME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c34_ManipulatorME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c34_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c34_ManipulatorME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c34_ManipulatorME4901(S);
}

static void sf_opaque_set_sim_state_c34_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c34_ManipulatorME4901(S, st);
}

static void sf_opaque_terminate_c34_ManipulatorME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc34_ManipulatorME4901InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc34_ManipulatorME4901((SFc34_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c34_ManipulatorME4901(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c34_ManipulatorME4901
      ((SFc34_ManipulatorME4901InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c34_ManipulatorME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c34_ManipulatorME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c34_ManipulatorME4901(SimStruct *S)
{
  SFc34_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc34_ManipulatorME4901InstanceStruct *)utMalloc(sizeof
    (SFc34_ManipulatorME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc34_ManipulatorME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c34_ManipulatorME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c34_ManipulatorME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c34_ManipulatorME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c34_ManipulatorME4901;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c34_ManipulatorME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c34_ManipulatorME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c34_ManipulatorME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c34_ManipulatorME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c34_ManipulatorME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c34_ManipulatorME4901;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c34_ManipulatorME4901;
...
void c34_ManipulatorME4901_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c34_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c34_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c34_ManipulatorME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c34_ManipulatorME4901_method_dispatcher.\n"
