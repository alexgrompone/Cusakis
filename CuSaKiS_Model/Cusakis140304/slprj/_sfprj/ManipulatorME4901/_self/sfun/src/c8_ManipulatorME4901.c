...
static void initialize_c8_ManipulatorME4901(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void initialize_params_c8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void enable_c8_ManipulatorME4901(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void disable_c8_ManipulatorME4901(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void set_sim_state_c8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_ManipulatorME4901(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void sf_c8_ManipulatorME4901(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_chartstep_c8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void initSimStructsc8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void registerMessagesc8_ManipulatorME4901
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_W, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_qd_reqW, const char_T *c8_identifier, real_T
  c8_y[3]);
static void c8_d_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[3]);
...
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_e_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[2]);
...
static const mxArray *c8_e_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_f_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[6]);
...
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_g_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[6]);
...
static const mxArray *c8_g_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_h_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[3]);
...
static void c8_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_b_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static real_T c8_det(SFc8_ManipulatorME4901InstanceStruct *chartInstance, real_T
                     c8_x[4]);
static void c8_realmin(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_eps(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_eml_matlab_zgetrf(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, real_T c8_A[4], real_T c8_b_A[4], int32_T c8_ipiv[2], int32_T *
  c8_info);
static real_T c8_abs(SFc8_ManipulatorME4901InstanceStruct *chartInstance, real_T
                     c8_x);
static void c8_below_threshold(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static real_T c8_eml_div(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x, real_T c8_y);
static void c8_eml_xger(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_A[4], real_T c8_b_A[4]);
static void c8_check_forloop_overflow_error(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, boolean_T c8_overflow);
static real_T c8_sqrt(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
                      real_T c8_x);
static void c8_eml_error(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static real_T c8_mpower(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a);
static void c8_c_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_b_eml_error(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_pinv(SFc8_ManipulatorME4901InstanceStruct *chartInstance, real_T
                    c8_A[6], real_T c8_X[6]);
static void c8_d_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_c_eml_error(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_eml_xgesvd(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_A[6], real_T c8_U[6], real_T c8_S[2], real_T c8_V[4]);
static real_T c8_eml_xnrm2(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_x[6], int32_T c8_ix0);
static void c8_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_b_x[6]);
static real_T c8_eml_xdotc(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_x[6], int32_T c8_ix0, real_T c8_y[6], int32_T c8_iy0);
static void c8_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, int32_T c8_ix0, real_T c8_y[6], int32_T c8_iy0,
  real_T c8_b_y[6]);
static real_T c8_b_eml_xnrm2(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_x[2], int32_T c8_ix0);
static void c8_b_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[2], int32_T c8_ix0, real_T c8_b_x[2]);
static void c8_b_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_y[3],
  int32_T c8_iy0, real_T c8_b_y[3]);
static void c8_c_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[3], int32_T c8_ix0, real_T c8_y[6],
  int32_T c8_iy0, real_T c8_b_y[6]);
static real_T c8_b_eml_xdotc(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_x[4], int32_T c8_ix0, real_T c8_y[4], int32_T c8_iy0);
static void c8_e_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_d_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, int32_T c8_ix0, real_T c8_y[4], int32_T c8_iy0,
  real_T c8_b_y[4]);
static void c8_c_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_b_x[6]);
static void c8_d_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[4], int32_T c8_ix0, real_T c8_b_x[4]);
static void c8_b_below_threshold(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_d_eml_error(SFc8_ManipulatorME4901InstanceStruct *chartInstance);
static void c8_eml_xrotg(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_b, real_T *c8_c_a, real_T *c8_b_b, real_T *c8_c,
  real_T *c8_s);
static void c8_eml_xrot(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4], int32_T c8_ix0, int32_T c8_iy0, real_T c8_c, real_T c8_s,
  real_T c8_b_x[4]);
static void c8_b_eml_xrot(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6], int32_T c8_ix0, int32_T c8_iy0, real_T c8_c, real_T c8_s,
  real_T c8_b_x[6]);
static void c8_eml_xswap(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4], int32_T c8_ix0, int32_T c8_iy0, real_T c8_b_x[4]);
static void c8_b_eml_xswap(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6], int32_T c8_ix0, int32_T c8_iy0, real_T c8_b_x[6]);
static void c8_eml_xgemm(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_k, real_T c8_A[4], real_T c8_B[6], real_T c8_C[6], real_T c8_b_C[6]);
static void c8_f_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_g_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static void c8_svd(SFc8_ManipulatorME4901InstanceStruct *chartInstance, real_T
                   c8_A[6], real_T c8_U[2]);
static void c8_eml_matlab_zsvdc(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, real_T c8_A[6], real_T c8_S[2]);
static real_T c8_c_eml_xnrm2(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6]);
static void c8_e_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6], real_T c8_b_x[6]);
static real_T c8_c_eml_xdotc(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6], real_T c8_y[6], int32_T c8_iy0);
static void c8_e_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_y[6], int32_T c8_iy0, real_T c8_b_y[6]);
static real_T c8_d_eml_xnrm2(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[3]);
static void c8_f_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[3], real_T c8_b_x[3]);
static void c8_f_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_y[2], real_T c8_b_y[2]);
static void c8_g_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[2], real_T c8_y[6], int32_T c8_iy0, real_T c8_b_y[6]);
static real_T c8_b_mpower(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a);
static void c8_b_pinv(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
                      real_T c8_A[4], real_T c8_X[4]);
static void c8_b_eml_xgesvd(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_A[4], real_T c8_U[4], real_T c8_S[2], real_T c8_V[4]);
static real_T c8_e_eml_xnrm2(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4]);
static void c8_g_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[4], real_T c8_b_x[4]);
static real_T c8_d_eml_xdotc(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4], real_T c8_y[4]);
static void c8_h_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_y[4], real_T c8_b_y[4]);
static void c8_b_eml_xgemm(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_k, real_T c8_A[4], real_T c8_B[4], real_T c8_C[4], real_T c8_b_C[4]);
static void c8_h_eml_scalar_eg(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
static const mxArray *c8_h_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_i_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_j_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_ManipulatorME4901, const
  char_T *c8_identifier);
static uint8_T c8_k_emlrt_marshallIn(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_matlab_zgetrf(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance, real_T c8_A[4], int32_T c8_ipiv[2], int32_T *c8_info);
static void c8_b_eml_xger(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_A[4]);
static void c8_b_sqrt(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
                      real_T *c8_x);
static void c8_h_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0);
static void c8_i_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, int32_T c8_ix0, real_T c8_y[6], int32_T c8_iy0);
static void c8_i_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[2], int32_T c8_ix0);
static void c8_j_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_y[3],
  int32_T c8_iy0);
static void c8_k_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, real_T c8_x[3], int32_T c8_ix0, real_T c8_y[6],
  int32_T c8_iy0);
static void c8_l_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_b_a, int32_T c8_ix0, real_T c8_y[4], int32_T c8_iy0);
static void c8_j_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0);
static void c8_k_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[4], int32_T c8_ix0);
static void c8_b_eml_xrotg(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T *c8_b_a, real_T *c8_b, real_T *c8_c, real_T *c8_s);
static void c8_c_eml_xrot(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4], int32_T c8_ix0, int32_T c8_iy0, real_T c8_c, real_T c8_s);
static void c8_d_eml_xrot(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6], int32_T c8_ix0, int32_T c8_iy0, real_T c8_c, real_T c8_s);
static void c8_c_eml_xswap(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[4], int32_T c8_ix0, int32_T c8_iy0);
static void c8_d_eml_xswap(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_x[6], int32_T c8_ix0, int32_T c8_iy0);
static void c8_c_eml_xgemm(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_k, real_T c8_A[4], real_T c8_B[6], real_T c8_C[6]);
static void c8_l_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6]);
static void c8_m_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_y[6], int32_T c8_iy0);
static void c8_m_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[3]);
static void c8_n_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[6], int32_T c8_ix0, real_T c8_y[2]);
static void c8_o_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[2], real_T c8_y[6], int32_T c8_iy0);
static void c8_n_eml_xscal(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_x[4]);
static void c8_p_eml_xaxpy(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  real_T c8_b_a, real_T c8_y[4]);
static void c8_d_eml_xgemm(SFc8_ManipulatorME4901InstanceStruct *chartInstance,
  int32_T c8_k, real_T c8_A[4], real_T c8_B[4], real_T c8_C[4]);
static void init_dsm_address_info(SFc8_ManipulatorME4901InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_ManipulatorME4901 = 0U;
}
  ...
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal = chartInstance->c8_is_active_c8_ManipulatorME4901;
  ...
  (SFc8_ManipulatorME4901InstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_W = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)),
  ...
  chartInstance->c8_is_active_c8_ManipulatorME4901 = c8_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
     "is_active_c8_ManipulatorME4901");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_ManipulatorME4901(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_ManipulatorME4901(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc8_ManipulatorME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_ManipulatorME4901_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_ManipulatorME4901), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_ManipulatorME4901);
  return c8_y;
}
...
void sf_c8_ManipulatorME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_ManipulatorME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_ManipulatorME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_ManipulatorME4901(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[14],T\"W\",},{M[1],M[5],T\"qd_req\",},{M[1],M[17],T\"qd_reqW\",},{M[8],M[0],T\"is_active_c8_ManipulatorME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_ManipulatorME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_ManipulatorME4901InstanceStruct *chartInstance;
    chartInstance = (SFc8_ManipulatorME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_ManipulatorME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_ManipulatorME4901(void *chartInstanceVar)
{
  enable_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_ManipulatorME4901(void *chartInstanceVar)
{
  disable_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_ManipulatorME4901(void *chartInstanceVar)
{
  sf_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_ManipulatorME4901(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_ManipulatorME4901
    ((SFc8_ManipulatorME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_ManipulatorME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c8_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_ManipulatorME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_ManipulatorME4901(S);
}

static void sf_opaque_set_sim_state_c8_ManipulatorME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_ManipulatorME4901(S, st);
}

static void sf_opaque_terminate_c8_ManipulatorME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_ManipulatorME4901InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ManipulatorME4901_optimization_info();
    }

    finalize_c8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_ManipulatorME4901((SFc8_ManipulatorME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_ManipulatorME4901(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_ManipulatorME4901(SimStruct *S)
{
...
static void mdlRTW_c8_ManipulatorME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_ManipulatorME4901(SimStruct *S)
{
  SFc8_ManipulatorME4901InstanceStruct *chartInstance;
  chartInstance = (SFc8_ManipulatorME4901InstanceStruct *)utMalloc(sizeof
    (SFc8_ManipulatorME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_ManipulatorME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_ManipulatorME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_ManipulatorME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_ManipulatorME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_ManipulatorME4901;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_ManipulatorME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_ManipulatorME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_ManipulatorME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_ManipulatorME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_ManipulatorME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_ManipulatorME4901;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_ManipulatorME4901;
...
void c8_ManipulatorME4901_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_ManipulatorME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_ManipulatorME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_ManipulatorME4901_method_dispatcher.\n"
