...
static void initialize_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void initialize_params_c10_CusakisME4901
  (SFc10_CusakisME4901InstanceStruct *chartInstance);
static void enable_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void disable_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_CusakisME4901
  (SFc10_CusakisME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_CusakisME4901
  (SFc10_CusakisME4901InstanceStruct *chartInstance);
static void set_sim_state_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void sf_c10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void initSimStructsc10_CusakisME4901(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
static void registerMessagesc10_CusakisME4901(SFc10_CusakisME4901InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_j, const char_T *c10_identifier, real_T
  c10_y[3]);
static void c10_b_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
...
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_collision, const char_T *c10_identifier);
static real_T c10_d_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_e_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_B, const char_T *c10_identifier, real_T
  c10_y[10]);
static void c10_f_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  real_T c10_y[10]);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_g_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_A, const char_T *c10_identifier, real_T
  c10_y[16]);
static void c10_h_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  real_T c10_y[16]);
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_i_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_QB_c, const char_T *c10_identifier, real_T
  c10_y[2]);
static void c10_j_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  real_T c10_y[2]);
...
static void c10_collision_function(SFc10_CusakisME4901InstanceStruct
  *chartInstance, real_T c10_epsilon, real_T c10_sigma_dock, real_T
  ...
  real_T c10_j[3]);
static void c10_eml_scalar_eg(SFc10_CusakisME4901InstanceStruct *chartInstance);
static real_T c10_dot(SFc10_CusakisME4901InstanceStruct *chartInstance, real_T
                      c10_a[2], real_T c10_b[2]);
static void c10_b_eml_scalar_eg(SFc10_CusakisME4901InstanceStruct *chartInstance);
static real_T c10_norm(SFc10_CusakisME4901InstanceStruct *chartInstance, real_T
  c10_x[2]);
static void c10_realmin(SFc10_CusakisME4901InstanceStruct *chartInstance);
static void c10_check_forloop_overflow_error(SFc10_CusakisME4901InstanceStruct
  *chartInstance, boolean_T c10_overflow);
static void c10_b_check_forloop_overflow_error(SFc10_CusakisME4901InstanceStruct
  *chartInstance, boolean_T c10_overflow);
static void c10_cross(SFc10_CusakisME4901InstanceStruct *chartInstance, real_T
                      c10_a[3], real_T c10_b[3], real_T c10_c[3]);
static real_T c10_b_norm(SFc10_CusakisME4901InstanceStruct *chartInstance,
  real_T c10_x[3]);
static real_T c10_b_dot(SFc10_CusakisME4901InstanceStruct *chartInstance, real_T
  c10_a[3], real_T c10_b[3]);
static void c10_c_eml_scalar_eg(SFc10_CusakisME4901InstanceStruct *chartInstance);
static const mxArray *c10_l_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_k_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_l_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_CusakisME4901, const char_T
  *c10_identifier);
static uint8_T c10_m_emlrt_marshallIn(SFc10_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_CusakisME4901InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_CusakisME4901 = 0U;
}
  ...
  (SFc10_CusakisME4901InstanceStruct *chartInstance)
{
  ...
  c10_c_hoistedGlobal = chartInstance->c10_is_active_c10_CusakisME4901;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  *c10_docking = c10_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c10_is_active_c10_CusakisME4901 = c10_l_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 14)),
     "is_active_c10_CusakisME4901");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_CusakisME4901(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc10_CusakisME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_CusakisME4901_get_eml_resolved_functions_info(void)
{
  ...
  (*c10_b_info)[66].context =
    "[E]//special.ern.nps.edu/srl$/CURRENT/Ongoing Projects/PROJECT_CuSaKiS/CuSaKiS_Model/Cusakis/collision_function.p";
  ...
  *c10_identifier)
{
  ...
  c10_y = c10_m_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_CusakisME4901), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_CusakisME4901);
  return c10_y;
}
...
void sf_c10_CusakisME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_CusakisME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_CusakisME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c10_CusakisME4901(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[36],T\"dock_sensB_c\",},{M[1],M[26],T\"docking\",},{M[1],M[33],T\"j\",},{M[1],M[18],T\"n_c\",},{M[8],M[0],T\"is_active_c10_CusakisME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 15, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_CusakisME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_CusakisME4901InstanceStruct *chartInstance;
    chartInstance = (SFc10_CusakisME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_CusakisME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_CusakisME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_CusakisME4901(void *chartInstanceVar)
{
  enable_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_CusakisME4901(void *chartInstanceVar)
{
  disable_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_CusakisME4901(void *chartInstanceVar)
{
  sf_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_CusakisME4901(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_CusakisME4901
    ((SFc10_CusakisME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_CusakisME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c10_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_CusakisME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_CusakisME4901(S);
}

static void sf_opaque_set_sim_state_c10_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_CusakisME4901(S, st);
}

static void sf_opaque_terminate_c10_CusakisME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_CusakisME4901InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_CusakisME4901_optimization_info();
    }

    finalize_c10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_CusakisME4901((SFc10_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_CusakisME4901(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2950699947U));
  ssSetChecksum1(S,(1858791577U));
  ssSetChecksum2(S,(3216240148U));
  ssSetChecksum3(S,(3963073272U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_CusakisME4901(SimStruct *S)
{
  SFc10_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc10_CusakisME4901InstanceStruct *)utMalloc(sizeof
    (SFc10_CusakisME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_CusakisME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_CusakisME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_CusakisME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_CusakisME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_CusakisME4901;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_CusakisME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_CusakisME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_CusakisME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_CusakisME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_CusakisME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_CusakisME4901;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_CusakisME4901;
...
void c10_CusakisME4901_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_CusakisME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_CusakisME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_CusakisME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_CusakisME4901_method_dispatcher.\n"
