...
static void initialize_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void initialize_params_c23_CusakisME4901
  (SFc23_CusakisME4901InstanceStruct *chartInstance);
static void enable_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void disable_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void c23_update_debugger_state_c23_CusakisME4901
  (SFc23_CusakisME4901InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_CusakisME4901
  (SFc23_CusakisME4901InstanceStruct *chartInstance);
static void set_sim_state_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c23_st);
static void finalize_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void sf_c23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void initSimStructsc23_CusakisME4901(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
static void registerMessagesc23_CusakisME4901(SFc23_CusakisME4901InstanceStruct *
  chartInstance);
...
static const mxArray *c23_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_emlrt_marshallIn(SFc23_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c23_y, const char_T *c23_identifier);
static real_T c23_b_emlrt_marshallIn(SFc23_CusakisME4901InstanceStruct
...
static const mxArray *c23_b_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_c_emlrt_marshallIn(SFc23_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_d_emlrt_marshallIn(SFc23_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c23_b_is_active_c23_CusakisME4901, const char_T
  *c23_identifier);
static uint8_T c23_e_emlrt_marshallIn(SFc23_CusakisME4901InstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_CusakisME4901InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_CusakisME4901 = 0U;
}
  ...
  (SFc23_CusakisME4901InstanceStruct *chartInstance)
{
  ...
  c23_b_hoistedGlobal = chartInstance->c23_is_active_c23_CusakisME4901;
  ...
  *chartInstance, const mxArray *c23_st)
{
  ...
  *c23_y = c23_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c23_u,
    0)), "y");
  chartInstance->c23_is_active_c23_CusakisME4901 = c23_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c23_u, 1)),
     "is_active_c23_CusakisME4901");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_CusakisME4901(chartInstance);
  ...
  *c23_inData)
{
  ...
  const mxArray *c23_y = NULL;
  SFc23_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc23_CusakisME4901InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_CusakisME4901_get_eml_resolved_functions_info(void)
{
  ...
  *c23_identifier)
{
  ...
  c23_y = c23_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_CusakisME4901), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_CusakisME4901);
  return c23_y;
}
...
void sf_c23_CusakisME4901_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c23_CusakisME4901_get_autoinheritance_info(void)
{
...
mxArray *sf_c23_CusakisME4901_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c23_CusakisME4901(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c23_CusakisME4901\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_CusakisME4901_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc23_CusakisME4901InstanceStruct *chartInstance;
    chartInstance = (SFc23_CusakisME4901InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c23_CusakisME4901(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_CusakisME4901InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
    chartInstanceVar);
  initialize_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_CusakisME4901(void *chartInstanceVar)
{
  enable_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c23_CusakisME4901(void *chartInstanceVar)
{
  disable_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_CusakisME4901(void *chartInstanceVar)
{
  sf_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c23_CusakisME4901(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c23_CusakisME4901
    ((SFc23_CusakisME4901InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c23_CusakisME4901();/* state var info */
...
extern void sf_internal_set_sim_state_c23_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c23_CusakisME4901(SimStruct* S)
{
  return sf_internal_get_sim_state_c23_CusakisME4901(S);
}

static void sf_opaque_set_sim_state_c23_CusakisME4901(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c23_CusakisME4901(S, st);
}

static void sf_opaque_terminate_c23_CusakisME4901(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_CusakisME4901InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_CusakisME4901_optimization_info();
    }

    finalize_c23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_CusakisME4901((SFc23_CusakisME4901InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_CusakisME4901(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c23_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c23_CusakisME4901(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_CusakisME4901(SimStruct *S)
{
  SFc23_CusakisME4901InstanceStruct *chartInstance;
  chartInstance = (SFc23_CusakisME4901InstanceStruct *)utMalloc(sizeof
    (SFc23_CusakisME4901InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_CusakisME4901InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_CusakisME4901;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_CusakisME4901;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_CusakisME4901;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c23_CusakisME4901;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c23_CusakisME4901;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_CusakisME4901;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_CusakisME4901;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_CusakisME4901;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_CusakisME4901;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_CusakisME4901;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c23_CusakisME4901;
...
void c23_CusakisME4901_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_CusakisME4901(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_CusakisME4901(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_CusakisME4901(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_CusakisME4901_method_dispatcher.\n"
